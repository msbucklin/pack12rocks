...
<input type="hidden" name="Form_ID" id="Form_ID" value="393">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormList.aspx?Menu_Item_ID=334&amp;Stack=1">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormList.aspx?Menu_Item_ID=334&amp;Stack=1&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        ...
        <span style="display:inline;">
        <input class="btn btn-sm btn-primary" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="120" id="BUTTON1" type="button" name="add" title="Add a new row to this table" value="Add a New Item" onclick="LinkTo('FormDetail.aspx?Menu_Item_ID=334&amp;Form_ID=394&amp;FK=0&amp;ID=0&amp;Stack=2','');">
        </span>
      </div>
    </div>
  </div>
</div>
<div class="new-row" id="fs1208">
  <div class="container-fluid container-flex">
    <input type="hidden" name="OP56071" id="OP56071" value="">
  </div>
</div>
<div class="new-row" id="fs1210">
  <div class="container-fluid container-flex">
    <div class="center-block table-responsive">
      <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid1210">
        <thead>
        <tr>
          <input type="hidden" name="ROWCOUNTCB1210" id="ROWCOUNTCB1210" value="0">
          <th class="unsortable">
          &nbsp;
          </th>
          <th>
  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        ...
        <span style="display:inline;">
        <input class="btn btn-sm btn-primary" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="140" id="BUTTON1" type="button" name="add" title="Add a new row to this table" value="Add a New Item" onclick="LinkTo('FormDetail.aspx?Menu_Item_ID=334&amp;Form_ID=394&amp;FK=0&amp;ID=0&amp;Stack=2','');">
        </span>
      </div>
    </div>
  </div>
