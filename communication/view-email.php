...
<link rel="stylesheet" type="text/css" href="https://www.TroopWebHost.org/CSS/bootstrap_override_v11.css">
<link rel="stylesheet" type="text/css" href="https://www.TroopWebHost.org/CSS/bootstrap_override_colors_Cub_Scouts.css">
...
<script src="ckeditor/ckeditor.js?v=2"></script><style>.cke{visibility:hidden;}</style>
  ...
  <input type="hidden" name="Form_ID" id="Form_ID" value="198">
  ...
  <input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=336&amp;Form_ID=198&amp;FK=0&amp;ID=2563&amp;Stack=2">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <br><br>
          The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=336&amp;Form_ID=198&amp;FK=0&amp;ID=2563&amp;Stack=2&amp;Application_ID=2840
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="new-row" id="fs530">
    <div class="container-fluid container-flex">
      <div class="center-block">
        <div class="text-center">
          <span style="display:inline;">
          <input class="btn btn-sm btn-danger" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="110" id="BUTTON0" type="button" name="cancel" title="Exit" value="Exit" onclick="buttonlink(this,'N');">
          </span>
        </div>
      </div>
    </div>
  </div>
  <div class="new-row" id="fs529">
    <div class="container-fluid container-flex">
      <div class="center-block ">
        <table class="no-border">
          <tbody>
          <tr id="DIVENTRY295117">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY295117" style="visibility: hidden">
              *
              </span>
              Sent On
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY295117" id="RVALENTRY295117" value="Y">
          ...
          <tr id="DIVENTRY29552">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY29552" style="visibility: hidden">
              *
              </span>
              Sender
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY29552" id="RVALENTRY29552" value="Y">
              <span class="text-left">
              msbucklin@icloud.com
              </span>
            </td>
          </tr>
          <tr id="DIVENTRY2949140">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY2949140" style="visibility: hidden">
              *
              </span>
              Subject
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY2949140" id="RVALENTRY2949140" value="Y">
              <span class="text-left">
              test
              </span>
            </td>
          </tr>
          <tr id="DIVENTRY295080">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY295080" style="visibility: hidden">
              *
              </span>
              Message
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY295080" id="RVALENTRY295080" value="N">
              <span class="text-left">
              <p>test</p>
              </span>
            </td>
          </tr>
          <tr id="DIVENTRY295350">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY295350" style="visibility: hidden">
              *
              </span>
              Attachment
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY295350" id="RVALENTRY295350" value="N">
              <span class="text-left">

              </span>
            </td>
          </tr>
          <tr id="DIVENTRY43390107">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY43390107" style="visibility: hidden">
              *
              </span>
              Attachment #1
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY43390107" id="RVALENTRY43390107" value="N">
              <span class="text-left">
              &nbsp;
              </span>
          ...
          <tr id="DIVENTRY43391107">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY43391107" style="visibility: hidden">
              *
              </span>
              Attachment #2
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY43391107" id="RVALENTRY43391107" value="N">
              <span class="text-left">
              &nbsp;
              </span>
          ...
          <tr id="DIVENTRY43392107">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY43392107" style="visibility: hidden">
              *
              </span>
              Attachment #3
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY43392107" id="RVALENTRY43392107" value="N">
              <span class="text-left">
              &nbsp;
              </span>
          ...
          <tr id="DIVENTRY24186100">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY24186100" style="visibility: hidden">
              *
              </span>
              Send To
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY24186100" id="RVALENTRY24186100" value="Y">
              <span class="text-left">
              email
              </span>
            </td>
  ...
  <div class="new-row" id="fs537">
    <div class="container-fluid container-flex">
      <div class="center-block table-responsive">
        <table class="table-condensed">
          <tbody>
          <tr>
            <td class="text-center " id="TD537ROW0DATA2977">
              Bucklin, Michael
            </td>
          </tr>
          </tbody>
