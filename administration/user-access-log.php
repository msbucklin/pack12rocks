...
<input type="hidden" name="Form_ID" id="Form_ID" value="1572">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=343&amp;Form_ID=1572&amp;FK=0&amp;ID=211690&amp;Stack=2">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=343&amp;Form_ID=1572&amp;FK=0&amp;ID=211690&amp;Stack=2&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<div class="new-row" id="fs7746">
  <div class="container-fluid container-flex">
    <div class="center-block ">
      <table class="no-border">
        <tbody>
        <tr id="DIVENTRY30184104">
          <td class="text-right">
            <label class="control-label">
            <span class="RequiredIndicator" id="RDIVENTRY30184104" style="visibility: hidden">
            *
            </span>
            User Login
            </label>
          ...
          <td class="text-left">
            <input type="hidden" name="RVALENTRY30184104" id="RVALENTRY30184104" value="Y">
            <span class="text-left">
            AAarons
            </span>
          </td>
        </tr>
        <tr id="DIVENTRY301872">
          <td class="text-right">
            <label class="control-label">
            <span class="RequiredIndicator" id="RDIVENTRY301872" style="visibility: hidden">
            *
            </span>
            Membership Record
            </label>
          ...
          <td class="text-left">
            <input type="hidden" name="RVALENTRY301872" id="RVALENTRY301872" value="Y">
            <span class="text-left">
            Aarons, Andrew
            </span>
          </td>
        </tr>
        <tr id="DIVENTRY3018569">
          <td class="text-right">
            <label class="control-label">
            <span class="RequiredIndicator" id="RDIVENTRY3018569" style="visibility: hidden">
            *
            </span>
            Number of Pages Accessed Recently
            </label>
          </td>
          <td class="text-left">
            <input type="hidden" name="RVALENTRY3018569" id="RVALENTRY3018569" value="N">
            <span class="text-left">
            1
            </span>
          </td>
...
<div class="new-row" id="fs7748">
  <div class="container-fluid container-flex">
    <div class="center-block table-responsive">
      <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid7748">
        <thead>
        <tr>
          <input type="hidden" name="ROWCOUNTCB7748" id="ROWCOUNTCB7748" value="1">
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 0);return false;">Access Time<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 1);return false;">Menu Item<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 2);return false;">Page<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 3);return false;">IP Address<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
        </tr>
        </thead>
        <tbody>
        <tr>
          <td class="text-center " id="TD7748ROW0DATA30193">
            02/18/2025 8:29 PM
          </td>
          <td class="text-center " id="TD7748ROW0DATA30195">
            On-Line Payments
          </td>
          <td class="text-center " id="TD7748ROW0DATA30196">
            Monetary_Transaction_Pending_Deposit_List_Mine
          </td>
          <td class="text-center " id="TD7748ROW0DATA30197">
            136.62.72.224
          </td>
        </tr>
        </tbody>
        ...
        <tr>
          <td colspan="4" class="text-center">
            <input type="button" value="Print (Export to PDF)" onclick="window.open('FormReport.aspx?Menu_Item_ID=343&amp;Form_ID=1572&amp;ID=211690&amp;Stack=2&amp;SectionID=7748&amp;ReportFormat=PDF','_blank');"> &nbsp; &nbsp; <input type="button" value="Open in Excel" onclick="window.open('FormReport.aspx?Menu_Item_ID=343&amp;Form_ID=1572&amp;ID=211690&amp;Stack=2&amp;SectionID=7748&amp;ReportFormat=XLS','_blank');">
          </td>
        </tr>
        </tfoot>
      </table>
