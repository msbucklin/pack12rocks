...
<script src="/ckeditor/ckeditor.js?v=2"></script><style>.cke{visibility:hidden;}</style>
  ...
  <input type="hidden" name="Menu_Item_ID" id="Menu_Item_ID" value="7230">
  <input type="hidden" name="Form_ID" id="Form_ID" value="7121">
  ...
  <input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=7230&amp;Stack=0">
  ...
  <div id="toolsmenu" class="navtools">
    ...
    <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=258&amp;Stack=0&amp;Menu_Item_ID=7230">Change My Password</a></li>
    <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=2568&amp;Stack=0&amp;Menu_Item_ID=7230">Configure My Quick Menu</a></li>
    <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=1951&amp;Stack=0&amp;Menu_Item_ID=7230">Bookmark This Site</a></li>
    </ul>
  </div>
  <div id="helpmenu" class="navtools">
    <ul class="list-group">
    <li class="list-group-item"><a href="Help.aspx?ID=385" target="_blank">User Guide</a></li>
    <li class="list-group-item"><a href="https://www.youtube.com/playlist?list=PL4bC-UY63jygEqBauW0Ofz9FJBWsPkphf" target="_blank">Mobile App Tutorials</a></li>
    <li class="list-group-item"><a href="FormList.aspx?Form_ID=3937&amp;Stack=0&amp;Menu_Item_ID=7230">TroopWebHost User Forum</a></li>
    <li class="list-group-item"><a href="FormList.aspx?Form_ID=3948&amp;Stack=0&amp;Menu_Item_ID=7230">Enhancement Requests</a></li>
    <li class="list-group-item"><a href="FormList.aspx?Form_ID=3944&amp;Stack=0&amp;Menu_Item_ID=7230">My Support Tickets</a></li>
    <li class="list-group-item"><a href="FormList.aspx?Form_ID=3945&amp;Stack=0&amp;Menu_Item_ID=7230">My Unit's Support Tickets</a></li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <br><br>
          The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=7230&amp;Stack=0&amp;Application_ID=2840
        </div>
      </div>
    </div>
  </div>
  ...
  <p class="page-title">
  Automatically Send New User IDs
  </p>
  <input type="hidden" name="FK" id="FK" value="0">
  <input type="hidden" name="ID" id="ID" value="2913">
  <div class="new-row" id="fs23483">
    <div class="container-fluid container-flex">
      <div class="center-block " style="max-width: 800px; min-width: 200px;">
        <h3>
        Automatically Send User ID &amp; Password To New Users
        </h3>
        <p>
        This system can automatically generate an email to new members.  This email will contain their user ID and temporary password, along with a link to this site.  It can also include a message that you provide below.
        </p>
        <p>
        There must be at least one email address on the new member's record for this to occur.
        </p>
        <p>
        This is not retroactive.  If you turn on this feature, it will only generate an email for new users added after you turn it on.
        </p>
      </div>
    </div>
  </div>
  <div class="new-row" id="fs23481">
    <div class="container-fluid container-flex">
      <div class="center-block ">
        <table class="no-border">
          <tbody>
          <tr id="DIVENTRY6132711">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY6132711" style="visibility: visible">
              *
              </span>
              Automatically Send ID &amp; Password To New Users?
              </label>
            </td>
            <td class="text-left">
              <input type="hidden" name="RVALENTRY6132711" id="RVALENTRY6132711" value="Y">
              <input type="hidden" name="OLD6132711" id="OLD6132711" value="Y">
              <input type="checkbox" onclick="easyFieldExit(this)" tabindex="110" checked="" value="Y" id="ENTRY6132711" name="ENTRY6132711" size="1" title="Automatically send an email to new users with their user ID and password when their membership record is created?">
              <span class="entrypostscript">

              </span>
            </td>
          </tr>
          <tr id="DIVENTRY613281">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY613281" style="visibility: hidden">
              *
              </span>
              Email FROM Name
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY613281" id="RVALENTRY613281" value="N">
              <input type="hidden" name="OLD613281" id="OLD613281" value="Pack 12 Austin">
              <input type="text" class="form-control" id="ENTRY613281" name="ENTRY613281" tabindex="120" size="50" onblur="TestRegExp(this,'','')" maxlength="100" value="Pack 12 Austin" title="The FROM name to be displayed on the email.  This is a name, not an email address">
              <span class="entrypostscript">

              </span>
            </td>
          </tr>
          <tr id="DIVENTRY61329149">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY61329149" style="visibility: hidden">
              *
              </span>
              Subject Line
              </label>
            ...
            <td class="text-left">
              <input type="hidden" name="RVALENTRY61329149" id="RVALENTRY61329149" value="N">
              <input type="hidden" name="OLD61329149" id="OLD61329149" value="Log On To Our Website">
              <input type="text" class="form-control" id="ENTRY61329149" name="ENTRY61329149" tabindex="130" size="50" onblur="TestRegExp(this,'','')" maxlength="256" value="Log On To Our Website" title="The text to display in the subject line of this email">
              <span class="entrypostscript">

              </span>
            </td>
          </tr>
          <tr id="DIVENTRY61330127">
            <td class="text-right">
              <label class="control-label">
              <span class="RequiredIndicator" id="RDIVENTRY61330127" style="visibility: hidden">
              *
              </span>
              Email Message
              </label>
    ...
    <div class="container-fluid container-flex">
      <div class="center-block">
        <div class="text-center">
          ...
          <span style="display:inline;">
          <input class="btn btn-sm btn-success" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="150" id="BUTTON9" type="button" name="save" title="Save the information that you entered on this page" value="Save" onclick="buttonlink(this,'N');">
          </span>
          <span style="display:inline;">
          </span>
          <span style="display:inline;">
          <input class="btn btn-sm btn-warning" onmouseover="SetAction(this)" onmouseout="ResetAction()" type="reset" tabindex="160" id="BUTTON11" title="Discard the information that you entered on this page and restore the previous values" value="Reset" name="BUTTON11">
          </span>
        </div>
      </div>
    </div>
  </div>
  <input type="hidden" name="FirstControl" id="FirstControl" value="ENTRY6132711">
  </form>
