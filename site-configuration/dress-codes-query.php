      ...
      <div class="center-block search-container">
        <table class="table-align-top no-border">
          ...
          <tr>
            ...
            <td>
              <select name="OP501691" tabindex="120" onchange="TestQueryOperator(this)" onkeydown="submitSearch();" class="form-control" size="1" title="How" this="" column="" should="" be="" compared="" to="" the="" value="" you="" provide="">
            ...
            <td>
              <input type="text" onkeydown="submitSearch();" class="form-control" id="QUERY501691" name="QUERY501691" tabindex="130" size="50" disabled="" style="visibility: hidden" onblur="TestRegExp(this,'','')" maxlength="100" value="" title="The short name for a particular dress code">
              <span id="QAND501691" class="entrypostscript" style="visibility: hidden">...and...</span>
              <input type="text" onkeydown="submitSearch();" class="form-control" id="QUERY2501691" name="QUERY2501691" tabindex="140" size="50" disabled="" style="visibility: hidden" onblur="TestRegExp(this,'','')" maxlength="100" value="" title="The short name for a particular dress code">
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <select name="OP50170137" tabindex="150" onchange="TestQueryOperator(this)" onkeydown="submitSearch();" class="form-control" size="1" title="How" this="" column="" should="" be="" compared="" to="" the="" value="" you="" provide="">
                <option selected="" value=""> </option>
                <option value="begins with">Begins With</option>
                <option value="contains">Contains</option>
                <option value="ends with">Ends With</option>
            ...
            <td>
              <input type="text" onkeydown="submitSearch();" class="form-control" id="QUERY50170137" name="QUERY50170137" tabindex="160" size="50" disabled="" style="visibility: hidden" onblur="TestRegExp(this,'','')" maxlength="100" value="" title="A brief description of this dress code which will be displayed on every event where this dress code has been selected.">
              <span id="QAND50170137" class="entrypostscript" style="visibility: hidden">...and...</span>
              <input type="text" onkeydown="submitSearch();" class="form-control" id="QUERY250170137" name="QUERY250170137" tabindex="170" size="50" disabled="" style="visibility: hidden" onblur="TestRegExp(this,'','')" maxlength="100" value="" title="A brief description of this dress code which will be displayed on every event where this dress code has been selected.">
            </td>
          </tr>
          </tbody>
        </table>
  ...
  <div class="new-row">
    <div class="container-fluid container-flex">
      <div class="center-block">
        <div class="text-center">
          <span style="display:inline;">
          <input class="btn btn-sm btn-info" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="180" id="BUTTON0" type="submit" name="show" title="Show the rows that match the selection criteria entered above" value="Show" onclick="buttonlink(this);"><script>function submitSearch(){if (window.event.keyCode==13)  {    var button = document.getElementById('BUTTON0');    buttonlink(button);  }}</script>
          </span>
        </div>
      </div>
    </div>
