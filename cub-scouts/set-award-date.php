...
<input type="hidden" name="Form_ID" id="Form_ID" value="293">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormRunProcedure.aspx?Menu_Item_ID=420&amp;Stack=1">
...
<div id="toolsmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=258&amp;Stack=0&amp;Menu_Item_ID=420">Change My Password</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=2568&amp;Stack=0&amp;Menu_Item_ID=420">Configure My Quick Menu</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=1951&amp;Stack=0&amp;Menu_Item_ID=420">Bookmark This Site</a></li>
  </ul>
</div>
<div id="helpmenu" class="navtools">
  <ul class="list-group">
  <li class="list-group-item"><a href="Help.aspx?ID=246" target="_blank">User Guide</a></li>
  <li class="list-group-item"><a href="https://www.youtube.com/playlist?list=PL4bC-UY63jygEqBauW0Ofz9FJBWsPkphf" target="_blank">Mobile App Tutorials</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3937&amp;Stack=0&amp;Menu_Item_ID=420">TroopWebHost User Forum</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3948&amp;Stack=0&amp;Menu_Item_ID=420">Enhancement Requests</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3944&amp;Stack=0&amp;Menu_Item_ID=420">My Support Tickets</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3945&amp;Stack=0&amp;Menu_Item_ID=420">My Unit's Support Tickets</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormRunProcedure.aspx?Menu_Item_ID=420&amp;Stack=1&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <table class="no-border">
        <tbody>
        <tr id="DIVENTRY000000016">
          <td class="text-right">
            <label class="control-label">
            <span class="entryprompt" id="RDIVENTRY000000016" style="visibility: visible">
            <font size="2" color="red">*</font>
            <input type="hidden" name="RVALENTRY000000016" value="Y">
            </span>
            Update all awards earned through
            </label>
          </td>
          <td class="text-left">
            <input type="hidden" name="OLD000000016" id="OLD000000016" value="">
            <input type="text" class="form-control" name="ENTRY000000016" id="ENTRY000000016" size="10" onblur="TestRegExp(this,/^(((((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))[\/-](1[6-9]|[2-9]\d)?\d{2})|(0?2[\/-]29[\/-](((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))|((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8])[\/-]((1[6-9]|[2-9]\d)?\d{2}))|(((1[6-9]|[2-9]\d)\d{2})[\/-](((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))[\/-](0?2[\/-]29)|(((1[6-9]|[2-9]\d)\d{2}))[\/-]((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8]))$/,'Please enter a valid date.')" maxlength="10" value="" title="This procedure will update all awards that were earned through this date, but have not yet been awarded." style="background-color: rgb(255, 255, 255);">
            <span class="entrypostscript">

            </span>
          </td>
        </tr>
        <tr id="DIVENTRY000000017">
          <td class="text-right">
            <label class="control-label">
            <span class="entryprompt" id="RDIVENTRY000000017" style="visibility: visible">
            <font size="2" color="red">*</font>
            <input type="hidden" name="RVALENTRY000000017" value="Y">
            </span>
            Date Awarded
            </label>
          </td>
          <td class="text-left">
            <input type="hidden" name="OLD000000017" id="OLD000000017" value="">
            <input type="text" class="form-control" name="ENTRY000000017" id="ENTRY000000017" size="10" onblur="TestRegExp(this,/^(((((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))[\/-](1[6-9]|[2-9]\d)?\d{2})|(0?2[\/-]29[\/-](((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))|((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8])[\/-]((1[6-9]|[2-9]\d)?\d{2}))|(((1[6-9]|[2-9]\d)\d{2})[\/-](((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))[\/-](0?2[\/-]29)|(((1[6-9]|[2-9]\d)\d{2}))[\/-]((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8]))$/,'Please enter a valid date.')" maxlength="10" value="" title="The date on which these merit badges, rank advancements, and other awards were awarded.">
            <span class="entrypostscript">
...
<div class="new-row" id="fs864">
  <div class="container-fluid container-flex">
    <div class="center-block " style="max-width: 600px; min-width: 200px;">
      <p>
      This procedure will set the "Date Awarded" on all awards that were earned on or before the date specified above, but which have not yet been awarded.
      </p>
      <p>
      Do not use this function until AFTER you have printed the list of pending awards.  Once run, the effects of this procedure cannot be cancelled except by updating each award individually.
      </p>
    </div>
  </div>
</div>
<input type="hidden" name="FirstControl" id="FirstControl" value="ENTRY000000016">
</form>
