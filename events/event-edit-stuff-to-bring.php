...
<input type="hidden" name="Form_ID" id="Form_ID" value="5441">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=5441&amp;Stack=3&amp;ID=581&amp;FK=0">
...
<div id="helpmenu" class="navtools">
  <ul class="list-group">
  <li class="list-group-item"><a href="Help.aspx?ID=297" target="_blank">User Guide</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=5441&amp;Stack=3&amp;ID=581&amp;FK=0&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<div class="new-row" id="fs18423">
  <div class="container-fluid container-flex">
    <div class="center-block ">
      <table class="no-border">
        <tbody>
        <tr id="DIVENTRY5239869">
          <td class="text-center" "="" colspan="1">
            <input type="hidden" name="RVALENTRY5239869" id="RVALENTRY5239869" value="">
  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        ...
        <span style="display:inline;">
        <input class="btn btn-sm btn-success" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="130" id="BUTTON8" type="button" name="save add child" title="Add Stuff To Bring" value="Add Stuff To Bring" onclick="buttonlink(this,'N');">
        </span>
      </div>
    </div>
  </div>
</div>
<div class="new-row" id="fs18407">
  <div class="container-fluid container-flex">
    <div class="center-block table-responsive">
      <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid18407">
        <thead>
        <tr>
          <input type="hidden" name="ROWCOUNTCB18407" id="ROWCOUNTCB18407" value="0">
          <th class="unsortable">
          &nbsp;
          </th>
          <th>
