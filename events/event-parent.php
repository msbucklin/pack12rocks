      ...
      <td class="quickmenu1">
        <table>
          <tbody><tr>
            ...
            <td class="navlink">
              <a href="javascript:LinkTo('FormReport.aspx?Menu_Item_ID=375&amp;Stack=2&amp;ReportFormat=PDF','');">Den List By Den</a>
            </td>
          </tr>
        </tbody></table>
      </td>
  ...
  <div class="new-row" id="fs6333">
    <div class="container-fluid container-flex">
      <div class="center-block">
        <div class="text-center">
          <span style="display:inline;">
          <input class="btn btn-sm btn-info" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="270" id="BUTTON23" type="button" name="save continue" title="Send Me An Invitation" value="Send Me An Invitation" onclick="buttonlink(this,'N');">
          </span>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid container-flex">
      <div class="center-block table-responsive">
        <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid5742">
          <thead>
          <tr>
            <input type="hidden" name="ROWCOUNTCB5742" id="ROWCOUNTCB5742" value="2">
          ...
          <tr>
            ...
            <td class="text-center " id="TD5742ROW0DATA22464">
              ...
              <span style="white-space: nowrap;"><input type="radio" id="CB5742ROW0DATA22464" name="CB5742ROW0DATA22464" tabindex="280" onclick="easyFieldExit(this)" checked="" value="Y">Yes</span> &nbsp; <span style="white-space: nowrap;"><input type="radio" id="CB5742ROW0DATA22464" name="CB5742ROW0DATA22464" tabindex="280" onclick="easyFieldExit(this)" value="N">No</span> &nbsp; <span style="white-space: nowrap;"><input type="radio" id="CB5742ROW0DATA22464" name="CB5742ROW0DATA22464" tabindex="280" onclick="easyFieldExit(this)" value="?">Unknown</span>
              </span>
            </td>
            <td class="text-center " id="TD5742ROW0DATA29714">
              <input type="hidden" name="OLDCB5742ROW0DATA29714" id="OLDCB5742ROW0DATA29714" value="">
              <input type="text" class="form-control" id="CB5742ROW0DATA29714" name="CB5742ROW0DATA29714" tabindex="280" size="7" onblur="TestRegExp(this,/^[+-]?\d\d*$/,'This field will only accept positive numbers with no decimal points or commas.')" maxlength="7" value="" title="The number of guests this person will bring (does not include the person who signed up)" style="background-color: rgb(255, 255, 255);">
            </td>
            <td class="text-center " id="TD5742ROW0DATA21832">
              <input type="hidden" name="OLDCB5742ROW0DATA21832" id="OLDCB5742ROW0DATA21832" value="">
              <input type="text" class="form-control" id="CB5742ROW0DATA21832" name="CB5742ROW0DATA21832" tabindex="280" size="50" onblur="TestRegExp(this,'','')" maxlength="100" value="" title="This is a comment about this person's participation in this event.">
            </td>
          </tr>
          <tr>
            <input type="hidden" name="CHILDCB5742ROW1" id="CHILDCB5742ROW1" value="244156">
            <td class="text-center " id="TD5742ROW1DATA21830">
              Bucklin, Michael3
            </td>
            <td class="text-center " id="TD5742ROW1DATA22464">
              <input type="hidden" name="OLDCB5742ROW1DATA22464" id="OLDCB5742ROW1DATA22464" value="?">
              <span class="text-left" id="SPAN5742ROW1DATA22464" name="SPAN5742ROW1DATA22464">
              <span style="white-space: nowrap;"><input type="radio" id="CB5742ROW1DATA22464" name="CB5742ROW1DATA22464" tabindex="280" onclick="easyFieldExit(this)" value="Y">Yes</span> &nbsp; <span style="white-space: nowrap;"><input type="radio" id="CB5742ROW1DATA22464" name="CB5742ROW1DATA22464" tabindex="280" onclick="easyFieldExit(this)" value="N">No</span> &nbsp; <span style="white-space: nowrap;"><input type="radio" id="CB5742ROW1DATA22464" name="CB5742ROW1DATA22464" tabindex="280" onclick="easyFieldExit(this)" checked="" value="?">Unknown</span>
              </span>
            </td>
            <td class="text-center " id="TD5742ROW1DATA29714">
              <input type="hidden" name="OLDCB5742ROW1DATA29714" id="OLDCB5742ROW1DATA29714" value="">
              <input type="text" class="form-control" id="CB5742ROW1DATA29714" name="CB5742ROW1DATA29714" tabindex="280" size="7" onblur="TestRegExp(this,/^[+-]?\d\d*$/,'This field will only accept positive numbers with no decimal points or commas.')" maxlength="7" value="" title="The number of guests this person will bring (does not include the person who signed up)" style="background-color: rgb(255, 255, 255);">
            </td>
            <td class="text-center " id="TD5742ROW1DATA21832">
              <input type="hidden" name="OLDCB5742ROW1DATA21832" id="OLDCB5742ROW1DATA21832" value="">
              <input type="text" class="form-control" id="CB5742ROW1DATA21832" name="CB5742ROW1DATA21832" tabindex="280" size="50" onblur="TestRegExp(this,'','')" maxlength="100" value="" title="This is a comment about this person's participation in this event.">
            </td>
          </tr>
          </tbody>
        </table>
    ...
    <div class="container-fluid container-flex">
      <div class="center-block table-responsive">
        <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid730">
          <thead>
          <tr>
            <input type="hidden" name="ROWCOUNTCB730" id="ROWCOUNTCB730" value="11">
            <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 0);return false;">Participant<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
  ...
  <div class="new-row">
    <div class="container-fluid container-flex">
      <div class="center-block">
        <div class="text-center">
          <span style="display:inline;">
          <input class="btn btn-sm btn-info" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="370" id="BUTTON0" type="button" name="save continue" title="Print Participant List" value="Print Participant List" onclick="LinkTo('FormReportMultiSection.aspx?Menu_Item_ID=318&amp;Form_ID=326&amp;FK=581&amp;ID=581&amp;Stack=2','FormReportMultiSectionaspxWindow');">
          </span>
          <span style="display:inline;">
