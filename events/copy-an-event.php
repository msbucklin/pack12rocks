...
<input type="hidden" name="Menu_Item_ID" id="Menu_Item_ID" value="325">
<input type="hidden" name="Form_ID" id="Form_ID" value="404">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormRunProcedure.aspx?Menu_Item_ID=325&amp;Stack=1">
...
<div id="toolsmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=258&amp;Stack=0&amp;Menu_Item_ID=325">Change My Password</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=2568&amp;Stack=0&amp;Menu_Item_ID=325">Configure My Quick Menu</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=1951&amp;Stack=0&amp;Menu_Item_ID=325">Bookmark This Site</a></li>
  </ul>
</div>
<div id="helpmenu" class="navtools">
  <ul class="list-group">
  <li class="list-group-item"><a href="Help.aspx?ID=91" target="_blank">User Guide</a></li>
  <li class="list-group-item"><a href="https://www.youtube.com/playlist?list=PL4bC-UY63jygEqBauW0Ofz9FJBWsPkphf" target="_blank">Mobile App Tutorials</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3937&amp;Stack=0&amp;Menu_Item_ID=325">TroopWebHost User Forum</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3948&amp;Stack=0&amp;Menu_Item_ID=325">Enhancement Requests</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3944&amp;Stack=0&amp;Menu_Item_ID=325">My Support Tickets</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3945&amp;Stack=0&amp;Menu_Item_ID=325">My Unit's Support Tickets</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormRunProcedure.aspx?Menu_Item_ID=325&amp;Stack=1&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <table class="no-border">
        <tbody>
        <tr id="DIVENTRY000000018">
          <td class="text-right">
            <label class="control-label">
            <span class="entryprompt" id="RDIVENTRY000000018" style="visibility: visible">
            <font size="2" color="red">*</font>
            <input type="hidden" name="RVALENTRY000000018" value="Y">
            </span>
            Event To Copy
            </label>
          </td>
          <td class="text-left">
            <input type="hidden" name="OLD000000018" id="OLD000000018" value="0">
            <select name="ENTRY000000018" id="ENTRY000000018" class="form-control" size="1" title="This is the event that you wish to make multiple copies of going forward in time.  If this is a weekly meeting, it should be the last weekly meeting that you've created." onblur="TestRegExp(this,'','')" style="background-color: rgb(255, 255, 255);">
        ...
        <tr id="DIVENTRY000000019">
          <td class="text-right">
            <label class="control-label">
            <span class="entryprompt" id="RDIVENTRY000000019" style="visibility: visible">
            <font size="2" color="red">*</font>
            <input type="hidden" name="RVALENTRY000000019" value="Y">
            </span>
            Number of events to create
            </label>
          </td>
          <td class="text-left">
            <input type="hidden" name="OLD000000019" id="OLD000000019" value="">
            <input type="text" class="form-control" name="ENTRY000000019" id="ENTRY000000019" size="7" onblur="TestRegExp(this,/^[+-]?\d\d*$/,'This field will only accept positive numbers with no decimal points or commas.')" maxlength="7" value="" title="This is the number of new events this procedure will create">
            <span class="entrypostscript">

            </span>
          </td>
        </tr>
        <tr id="DIVENTRY000000020">
          <td class="text-right">
            <label class="control-label">
            <span class="entryprompt" id="RDIVENTRY000000020" style="visibility: visible">
            <font size="2" color="red">*</font>
            <input type="hidden" name="RVALENTRY000000020" value="Y">
            </span>
            Number of days between events
            </label>
          </td>
          <td class="text-left">
            <input type="hidden" name="OLD000000020" id="OLD000000020" value="7">
            <input type="text" class="form-control" name="ENTRY000000020" id="ENTRY000000020" size="7" onblur="TestRegExp(this,/^[+-]?\d\d*$/,'This field will only accept positive numbers with no decimal points or commas.')" maxlength="7" value="7" title="The procedure will add this number of days to the selected event to set the date of the next new event to create, and so on.  Set to 7 for weekly meetings.">
            <span class="entrypostscript">
...
<div class="new-row" id="fs1244">
  <div class="container-fluid container-flex">
    <div class="center-block " style="max-width: 500px; min-width: 200px;">
      <p>
      This procedure will make copies of the event you select, with each subsequent copy being the same number of days after the previous event.
      </p>
      <p>
      This is an excellent way to set up your meeting schedule for the year.  After creating all of your meetings you can then update individual meetings with information specific to that meeting.
      </p>
      <p>
      Always pick an event furthest in the future so the system doesn't create duplicate events on the same day.  And make sure the event you copy is perfect before you click the Continue button.
      </p>
    </div>
  </div>
</div>
<input type="hidden" name="FirstControl" id="FirstControl" value="ENTRY000000018">
</form>
