...
<input type="hidden" name="Form_ID" id="Form_ID" value="271">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormList.aspx?Menu_Item_ID=318&amp;Stack=1">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormList.aspx?Menu_Item_ID=318&amp;Stack=1&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<div class="new-row" id="fs799">
  <div class="container-fluid container-flex">
    <div class="center-block ">
      ...
      <table class="table table-striped table-bordered table-condensed table-responsive table-curved">
        <thead>
        <tr>
    ...
    <div class="modal fade" id="ModalCalendarPrint799" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <input class="btn btn-success" style="float: left;" tabindex="1001" type="button" value="Print" name="Print_Calendar_Button" id="Print_Calendar_Button" onclick="PrintCalendar799();">
            <button type="button" class="btn btn-danger" style="float: right;" tabindex="1002" data-dismiss="modal">Cancel</button>
          </div>
        </div>
      </div>
    </div>
