...
<input type="hidden" name="Form_ID" id="Form_ID" value="5442">
...
<div class="new-row" id="fs18424">
  <div class="container-fluid container-flex">
    <div class="center-block ">
      <table class="no-border">
        <tbody>
        <tr id="DIVENTRY5240369">
          <td class="text-center" "="" colspan="1">
            <input type="hidden" name="RVALENTRY5240369" id="RVALENTRY5240369" value="">
...
<div class="new-row" id="fs18405">
  <div class="container-fluid container-flex">
    ...
    <li>
    <a href="#" onclick="buttonlink(LinkTo('event-edit-stuff-to-bring.php','')" id="savelink5441" name="savelink5441">
    Stuff To Bring
    </a>
    </li>
    <li>
    <a href="#" onclick="buttonlink(LinkTo('event-edit-sign-up-list.php','')" id="savelink267" name="savelink267">
    Sign-up List
    </a>
    </li>
    </ul>
...
<div class="new-row" id="fs18402">
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        <span style="display:inline;">
        <input class="btn btn-sm btn-success" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="120" id="BUTTON7" type="button" name="save exit" title="Save this information to the database and exit from this page" value="Save &amp; Exit" onclick="buttonlink(this,'N');">
        </span>
        <span style="display:inline;">
        <input class="btn btn-sm btn-success" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="130" id="BUTTON8" type="button" name="save" title="Save the information that you entered on this page" value="Save" onclick="buttonlink(this,'N');">
        </span>
        <span style="display:inline;">
        <input class="btn btn-sm btn-danger" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="140" id="BUTTON9" type="button" name="cancel" title="Exit without saving this information" value="Cancel" onclick="buttonlink(this,'N');">
        </span>
        <span style="display:inline;">
...
<div class="new-row" id="fs18455">
  <div class="container-fluid container-flex">
    <div class="center-block table-responsive">
      <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid18455">
        <thead>
        <tr>
          <input type="hidden" name="ROWCOUNTCB18455" id="ROWCOUNTCB18455" value="0">
          <th class="unsortable">
          &nbsp;
          </th>
          <th>
