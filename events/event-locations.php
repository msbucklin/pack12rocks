  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        ...
        <span style="display:inline;">
        <input class="btn btn-sm btn-primary" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="120" id="BUTTON1" type="button" name="add" title="Add a new row to this table" value="Add a New Item" onclick="LinkTo('event-location-add.php','');">
        </span>
        <span style="display:inline;">
        </span>
        <span style="display:inline;">
