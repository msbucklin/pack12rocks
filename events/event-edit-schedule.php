...
<script language="JavaScript1.1">
 ...
 if (onLoad||thisfield.name=='ENTRY4391384')
{
  var Document_Type = trim(easyGetFieldValue('ENTRY4391384'));
  if (Document_Type=='URL Link')
  {
    easyEnableField('ENTRY4391375',false,true);
    easyEnableField('ENTRY4391385',true,true);
    easySetRequired('ENTRY4391375',false);
    easySetRequired('ENTRY4391385',false);
  }
  else
  {
    easyEnableField('ENTRY4391375',true,true);
    easyEnableField('ENTRY4391385',false,true);
    easySetRequired('ENTRY4391375',false);
    easySetRequired('ENTRY4391385',false);
  }
}

if (onLoad||thisfield.name=='ENTRY4861584')
{
  var Document_Type = trim(easyGetFieldValue('ENTRY4861584'));
  if (Document_Type=='URL Link')
  {
    easyEnableField('ENTRY4861575',false,true);
    easyEnableField('ENTRY4861585',true,true);
    easySetRequired('ENTRY4861575',false);
    easySetRequired('ENTRY4861585',false);
  }
  else
  {
    easyEnableField('ENTRY4861575',true,true);
    easyEnableField('ENTRY4861585',false,true);
    easySetRequired('ENTRY4861575',false);
    easySetRequired('ENTRY4861585',false);
  }
}
		...
		if (onLoad||thisfield.name=='ENTRY43895144')
		{
		  var startID = '43895143';
		  var endID =   '4389617';
		  ...
		  var allDay = easyGetFieldValue('ENTRY43895144');
		  if (allDay=='Y')
		  {
      ...
      if (thisfield.name=='DATE43895143')
		{
		  var endDateObj = document.getElementById('DATE4389617');
		  var endDate = endDateObj.value;
		  if (endDate == '')
		  {
			endDateObj.value = easyGetFieldValue('DATE43895143');
		  }
		}
...
<input type="hidden" name="Form_ID" id="Form_ID" value="3154">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=3154&amp;Stack=3&amp;ID=581&amp;FK=0">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=3154&amp;Stack=3&amp;ID=581&amp;FK=0&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<div class="new-row" id="fs18427">
  <div class="container-fluid container-flex">
    <div class="center-block ">
      <table class="no-border">
        <tbody>
        <tr id="DIVENTRY5241969">
          <td class="text-center" "="" colspan="1">
            <input type="hidden" name="RVALENTRY5241969" id="RVALENTRY5241969" value="">
...
<div class="new-row" id="fs13530">
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        <span style="display:inline;">
        <input class="btn btn-sm btn-danger" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="120" id="BUTTON7" type="button" name="cancel" title="Exit" value="Exit" onclick="buttonlink(this,'N');">
        </span>
        <span style="display:inline;">
        <input class="btn btn-sm btn-primary" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="130" id="BUTTON8" type="button" name="add" title="Add a new row to this table" value="Add a New Item" onclick="LinkTo('FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=168&amp;FK=581&amp;ID=0&amp;Stack=4','');">
        </span>
      </div>
    </div>
  </div>
</div>
<div class="new-row" id="fs13528">
  <div class="container-fluid container-flex">
    <div class="center-block table-responsive">
      <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid13528">
        <thead>
        <tr>
          <input type="hidden" name="ROWCOUNTCB13528" id="ROWCOUNTCB13528" value="0">
          <th class="unsortable">
          &nbsp;
          </th>
          <th>
...
<input type="hidden" name="FirstControl" id="FirstControl" value="BUTTON7">
</form>
