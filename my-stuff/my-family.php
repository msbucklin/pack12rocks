  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        ...
        <span style="display:inline;">
        <input class="btn btn-sm btn-info" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="120" id="BUTTON1" type="button" name="save continue" title="Make On-Line Payments" value="Make On-Line Payments" onclick="buttonlink(this,'N');">
        </span>
        <span style="display:inline;">
        </span>
      </div>
