    ...
    <td class="quickmenu1">
      <table>
        <tbody><tr>
          ...
          <td class="navlink">
            <a href="javascript:LinkTo('FormList.aspx?Menu_Item_ID=334&amp;Stack=1','');">Send E-Mail To E-Mail Group</a>
          </td>
        </tr>
      </tbody></table>
    </td>
      ...
      <div style="display: inline-block; margin-left: 10px; margin-right: 10px; width: calc(100% - 20px);">
        ...
        <div class="center-block">
          <table class="table-condensed">
            ...
            <tr>
              <td class="text-center">
                <p align="center"><b><a href="FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=259&amp;Stack=2&amp;ID=525">Pack Meeting</a></b><br>(Dec  8 2026  6:30PM)</p>
              </td>
            </tr>
            <tr>
              <td class="text-center">
                <p align="center"><b><a href="FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=259&amp;Stack=2&amp;ID=526">Pack Meeting</a></b><br>(Jan 12 2027  6:30PM)</p>
              </td>
            </tr>
            </tbody>
          </table>
