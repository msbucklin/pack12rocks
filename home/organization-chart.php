...
<input type="hidden" name="Menu_Item_ID" id="Menu_Item_ID" value="8610">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/formCustom.aspx?Menu_Item_ID=8610&amp;Stack=0&amp;Custom_Form_ID=14">
...
<div id="toolsmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=258&amp;Stack=0&amp;Menu_Item_ID=8610">Change My Password</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=2568&amp;Stack=0&amp;Menu_Item_ID=8610">Configure My Quick Menu</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=1951&amp;Stack=0&amp;Menu_Item_ID=8610">Bookmark This Site</a></li>
  </ul>
</div>
<div id="helpmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3937&amp;Stack=0&amp;Menu_Item_ID=8610">TroopWebHost User Forum</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3948&amp;Stack=0&amp;Menu_Item_ID=8610">Enhancement Requests</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3944&amp;Stack=0&amp;Menu_Item_ID=8610">My Support Tickets</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3945&amp;Stack=0&amp;Menu_Item_ID=8610">My Unit's Support Tickets</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/formCustom.aspx?Menu_Item_ID=8610&amp;Stack=0&amp;Custom_Form_ID=14&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<input type="hidden" name="Custom_Form_ID" id="Custom_Form_ID" value="14">
<div class="new-row">
  <div class="container-fluid container-flex">
    <div class="center-block " style="margin-bottom: 20px; max-width: 640px; min-width: 200px; ">
      <div style="display: inline-block; margin-left: 10px; margin-right: 10px; width: calc(100% - 20px);">
        <p><span style="font-size:36px;"><a href="https://drive.google.com/file/d/1n7oH4pM0vaIMW2emHwT5JEg-RHJff2RL/view?usp=sharing" target="_blank">Organization Chart</a></span></p>
      </div>
    </div>
  </div>
</div>
