...
<input type="hidden" name="Menu_Item_ID" id="Menu_Item_ID" value="6579">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/formCustom.aspx?Menu_Item_ID=6579&amp;Stack=0&amp;Custom_Form_ID=5">
...
<div id="toolsmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=258&amp;Stack=0&amp;Menu_Item_ID=6579">Change My Password</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=2568&amp;Stack=0&amp;Menu_Item_ID=6579">Configure My Quick Menu</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=1951&amp;Stack=0&amp;Menu_Item_ID=6579">Bookmark This Site</a></li>
  </ul>
</div>
<div id="helpmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3937&amp;Stack=0&amp;Menu_Item_ID=6579">TroopWebHost User Forum</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3948&amp;Stack=0&amp;Menu_Item_ID=6579">Enhancement Requests</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3944&amp;Stack=0&amp;Menu_Item_ID=6579">My Support Tickets</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3945&amp;Stack=0&amp;Menu_Item_ID=6579">My Unit's Support Tickets</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/formCustom.aspx?Menu_Item_ID=6579&amp;Stack=0&amp;Custom_Form_ID=5&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<input type="hidden" name="Custom_Form_ID" id="Custom_Form_ID" value="5">
<div class="new-row">
  <div class="container-fluid container-flex">
    <div class="center-block " style="margin-bottom: 20px; max-width: 640px; min-width: 200px; ">
      <div style="display: inline-block; margin-left: 10px; margin-right: 10px; width: calc(100% - 20px);">
        <h2>Pack 12 is 100% Parent Volunteer Led!</h2>

<p>As you know, Cub Scouting is a FAMILY activity. We have a wonderful group of leaders, but they need your help to make Pack 12 the very best it can be!</p>

<h2>Join us and help make Pack 12 ROCK!</h2>

<p>We would like to see every family volunteer in some way throughout the year. There are lots of opportunities, both large and small, so surely one fits your abilities and interests! Please let us know if you have any interest helping out with one or more of the volunteer opportunities listed. If you have any questions, please contact our Committee Chair.</p>

<p>Please take some time to consider if any of the following roles would interest you. These are critical roles necessary to ensuring the ongoing success of Pack 12:</p>

<p>PRIMARY VOLUNTEER NEEDS (click to see more info)</p>

<ul>
	<li><a href="https://docs.google.com/document/d/1qKA4MTIjRlstreXDJ0U7PNPUTkzi-hCC7RqAzOy4xvo/edit?usp=sharing" target="_blank">Den Leaders &amp; Assistant Den Leaders</a></li>
...
<div class="youtube-embed-wrapper" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden;"><iframe allowfullscreen="" frameborder="0" height="360" src="//www.youtube.com/embed/lKLXyjcwdc8" style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;" width="640"></iframe></div>
