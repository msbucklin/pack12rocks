...
<div id="mainmenu" class="navmenu">
  ...
  <li class="list-group-item"><a href="javascript:toggleLower('m8');">Membership <span id="m8-icon" class="fa fa-caret-right pull-right"></span></a></li>
  <div id="m8" class="navmenulower">
    ...
    <li class="list-group-item"><a href="javascript:toggleLower('m9');">Membership Reports <span id="m9-icon" class="fa fa-caret-right pull-right"></span></a></li>
    <div id="m9" class="navmenulower2">
      <ul class="list-group">
      <li class="list-group-item"><a href="javascript:toggleLower('m10');">Membership Directory <span id="m10-icon" class="fa fa-caret-right pull-right"></span></a></li>
      <div id="m10" class="navmenulower3">
        <ul class="list-group">
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m11');">Leader Directory <span id="m11-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m12');">Contact List <span id="m12-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m13');">Emergency Contact List <span id="m13-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m14');">Den List By Member Name <span id="m14-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m15');">Den List By Den <span id="m15-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m16');">Den List With Parent Info <span id="m16-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m17');">Medical Form Effective Dates <span id="m17-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <li class="list-group-item"><a href="javascript:toggleLower('m18');">Family Cross Reference <span id="m18-icon" class="fa fa-caret-right pull-right"></span></a></li>
  ...
  <li class="list-group-item"><a href="javascript:toggleLower('m19');">Resources <span id="m19-icon" class="fa fa-caret-right pull-right"></span></a></li>
      ...
      <div style="display: inline-block; margin-left: 10px; margin-right: 10px; width: calc(100% - 20px);">
        ...
        <div class="center-block">
          <table class="table-condensed">
            ...
            <tr>
              <td class="text-center">
                <p align="center"><b><a href="FormDetail.aspx?Menu_Item_ID=318&amp;Form_ID=259&amp;Stack=2&amp;ID=573">Webelos Den Meeting</a></b><br>(Nov  8 2026  4:00PM)</p>
              </td>
            </tr>
            <tr>
              <td class="text-center">
