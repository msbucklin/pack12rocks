...
<input type="hidden" name="Menu_Item_ID" id="Menu_Item_ID" value="1943">
<input type="hidden" name="Form_ID" id="Form_ID" value="3218">
...
<input type="hidden" name="Current_URL" id="Current_URL" value="https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=1943&amp;Stack=0">
...
<div id="toolsmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=258&amp;Stack=0&amp;Menu_Item_ID=1943">Change My Password</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=2568&amp;Stack=0&amp;Menu_Item_ID=1943">Configure My Quick Menu</a></li>
  <li class="list-group-item"><a href="FormDetail.aspx?Form_ID=1951&amp;Stack=0&amp;Menu_Item_ID=1943">Bookmark This Site</a></li>
  </ul>
</div>
<div id="helpmenu" class="navtools">
  ...
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3937&amp;Stack=0&amp;Menu_Item_ID=1943">TroopWebHost User Forum</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3948&amp;Stack=0&amp;Menu_Item_ID=1943">Enhancement Requests</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3944&amp;Stack=0&amp;Menu_Item_ID=1943">My Support Tickets</a></li>
  <li class="list-group-item"><a href="FormList.aspx?Form_ID=3945&amp;Stack=0&amp;Menu_Item_ID=1943">My Unit's Support Tickets</a></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; https://www.troopwebhostcs.org/FormDetail.aspx?Menu_Item_ID=1943&amp;Stack=0&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<p class="page-title">
Fund Balances As Of Date
</p>
<input type="hidden" name="FK" id="FK" value="0">
<input type="hidden" name="ID" id="ID" value="1">
<div class="new-row" id="fs13724">
  <div class="container-fluid container-flex">
    <div class="center-block " style="max-width: 500px; min-width: 200px;">
      <p>
      This report shows the balance of each fund as of the date specified below.
      </p>
    </div>
  </div>
</div>
<div class="new-row" id="fs13722">
  <div class="container-fluid container-flex">
    <div class="center-block ">
      <table class="no-border">
        <tbody>
        <tr id="DIVENTRY4427516">
          <td class="text-right">
            <label class="control-label">
            <span class="RequiredIndicator" id="RDIVENTRY4427516" style="visibility: visible">
            *
            </span>
            Effective Date
            </label>
...
<div class="new-row" id="fs13723">
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        <span style="display:inline;">
        <input class="btn btn-sm btn-success" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="120" id="BUTTON2" type="button" name="save" title="Continue" value="Continue" onclick="buttonlink(this,'Y');">
        </span>
        <span style="display:inline;">
...
<input type="hidden" name="FirstControl" id="FirstControl" value="ENTRY4427516">
</form>
