...
<input type="hidden" name="Current_URL" id="Current_URL" value="/money/transaction-add.php?Form_ID=319&amp;FK=2&amp;ID=2570&amp;Stack=3">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <br><br>
        The URL for this page is:&nbsp; &nbsp; /money/transaction-add.php?Form_ID=319&amp;FK=2&amp;ID=2570&amp;Stack=3&amp;Application_ID=2840
      </div>
    </div>
  </div>
</div>
...
<input type="hidden" name="ID" id="ID" value="2570">
      ...
      <table class="no-border">
        ...
        <tr id="DIVENTRY44612">
          ...
          <td class="text-left">
            ...
            <input type="hidden" name="OLD44612" id="OLD44612" value="1">
            <select id="ENTRY44612" name="ENTRY44612" class="form-control" onblur="TestRegExp(this,'','')" tabindex="110" title="The type of transaction determines the accounts that must be specified." onchange="UpdateDependentList(this,'ENTRY629692','3176','2840','1','2570','0','977','column');" size="1" style="background-color: rgb(255, 255, 255);">
              ...
              <option selected="" value="1">Deposit To Member Account</option>
        ...
        <tr id="DIVENTRY2608216" style="visibility: visible; display: table-row;">
          ...
          <td class="text-left">
            <input type="hidden" name="RVALENTRY2608216" id="RVALENTRY2608216" value="Y">
            <input type="hidden" name="OLD2608216" id="OLD2608216" value="01/13/2026">
            <input type="text" class="form-control" id="ENTRY2608216" name="ENTRY2608216" tabindex="130" size="12" onblur="TestRegExp(this,/^(((((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))[\/-](1[6-9]|[2-9]\d)?\d{2})|(0?2[\/-]29[\/-](((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))|((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8])[\/-]((1[6-9]|[2-9]\d)?\d{2}))|(((1[6-9]|[2-9]\d)\d{2})[\/-](((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))[\/-](0?2[\/-]29)|(((1[6-9]|[2-9]\d)\d{2}))[\/-]((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8]))$/,'Please enter a valid date.')" onfocus="FocusTestRegExp(this,/^(((((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))[\/-](1[6-9]|[2-9]\d)?\d{2})|(0?2[\/-]29[\/-](((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))|((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8])[\/-]((1[6-9]|[2-9]\d)?\d{2}))|(((1[6-9]|[2-9]\d)\d{2})[\/-](((0?[13578]|1[02])[\/-]31)|((0?[13-9]|1[0-2])[\/-](29|30)))|(((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))[\/-](0?2[\/-]29)|(((1[6-9]|[2-9]\d)\d{2}))[\/-]((0?[1-9])|(1[0-2]))[\/-](0?[1-9]|1\d|2[0-8]))$/,'Please enter a valid date.')" maxlength="10" value="01/13/2026" title="The date on which the deposit will be made.  The reconciliation function will display the sum of all transactions with the same deposit date.">&nbsp;<a href="#" tabindex="130" onclick="cal.select(window.easyform.ENTRY2608216,'ENTRY2608216X','MM/dd/yyyy', window.easyform.ENTRY2608216.value); return false;" name="ENTRY2608216X" id="ENTRY2608216X"><img src="/assets/images/calendar.gif" name="ENTRY2608216I" id="ENTRY2608216I"></a>
            <span class="entrypostscript">
        ...
        <tr id="DIVENTRY44631">
          ...
          <td class="text-left">
            ...
            <input type="hidden" name="OLD44631" id="OLD44631" value="Chk#1967 for Winter Overnight">
            <input type="text" class="form-control" id="ENTRY44631" name="ENTRY44631" tabindex="140" size="50" onblur="TestRegExp(this,'','')" maxlength="100" value="Chk#1967 for Winter Overnight" title="A description of this specific transaction">
            <span class="entrypostscript">
        ...
        <tr id="DIVENTRY446536">
          ...
          <td class="text-left">
            ...
            <input type="hidden" name="OLD446536" id="OLD446536" value="70.00">
            <input type="text" class="form-control" id="ENTRY446536" name="ENTRY446536" tabindex="160" size="9" onblur="TestRegExp(this,/^[+-]?(\d*)(\.\d\d?)?$/,'Please enter a number with no more than 2 digits after the decimal point.')" maxlength="9" value="70.00" title="The amount, in dollars and cents, of this transaction.">
            <span class="entrypostscript">
        ...
        <tr id="DIVENTRY44672" style="visibility: visible; display: table-row;">
          <td class="text-right">
            <label class="control-label">
            <span class="RequiredIndicator" id="RDIVENTRY44672" style="visibility: visible;">
            *
            </span>
          ...
          <td class="text-left">
            <input type="hidden" name="RVALENTRY44672" id="RVALENTRY44672" value="Y">
            <input type="hidden" name="OLD44672" id="OLD44672" value="2">
            <select id="ENTRY44672" name="ENTRY44672" class="form-control" onblur="TestRegExp(this,'','')" tabindex="180" title="The group account to be increased by the amount of this transaction." size="1">
        ...
        <tr id="DIVENTRY44692" style="visibility: visible; display: table-row;">
          <td class="text-right">
            <label class="control-label">
            <span class="RequiredIndicator" id="RDIVENTRY44692" style="visibility: visible;">
            *
            </span>
            Credit To Person
            </label>
          ...
          <td class="text-left">
            <input type="hidden" name="RVALENTRY44692" id="RVALENTRY44692" value="Y">
            <input type="hidden" name="OLD44692" id="OLD44692" value="625">
            <select id="ENTRY44692" name="ENTRY44692" class="form-control" onblur="TestRegExp(this,'','')" tabindex="200" title="The person whose account balance should be increased by the amount of this transaction" size="1">
              <option value="0"> </option>
              <option value="1018">Aarons, Andrew &nbsp; &nbsp; [0.00]</option>
              <option value="1027">Aarons, Ashley &nbsp; &nbsp; [0.00]</option>
              <option value="1086">Aarons, Stephen &nbsp; &nbsp; [0.00]</option>
              ...
              <option value="1209">Whittington, Aric &nbsp; &nbsp; [0.00]</option>
              <option value="1193">Whittington, Rowan &nbsp; &nbsp; [0.00]</option>
              <option selected="" value="625">Workman, Logan &nbsp; &nbsp; [0.00]</option>
            </select>
            <span class="entrypostscript">
        ...
        <tr id="DIVENTRY5737569">
          ...
          <td class="text-left">
            ...
            <input type="hidden" name="OLD5737569" id="OLD5737569" value="2570">
            <input type="hidden" name="ENTRY5737569" id="ENTRY5737569" value="2570">
  ...
  <div class="container-fluid container-flex">
    <div class="center-block">
      <div class="text-center">
        ...
        <input class="btn btn-sm btn-success" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="320" id="BUTTON23" type="button" name="save exit" title="Save this information to the database and exit from this page" value="Save &amp; Exit" onclick="LinkTo('/home/home.php','_top');">
        </span>
        <span style="display:inline;">
        <input class="btn btn-sm btn-danger" onmouseover="SetAction(this)" onmouseout="ResetAction()" tabindex="330" id="BUTTON24" type="button" name="cancel" title="Exit without saving this information" value="Cancel" onclick="buttonlink(this,'N');">
        </span>
        <span style="display:inline;">
        <input class="btn btn-sm btn-warning" onmouseover="SetAction(this)" onmouseout="ResetAction()" type="reset" tabindex="340" id="BUTTON25" title="Discard the information that you entered on this page and restore the previous values" value="Reset" name="BUTTON25">
        </span>
      </div>
    </div>
  </div>
</div>
<div class="new-row" id="fs19518">
  <div class="container-fluid container-flex">
...
<div class="new-row" id="fs19519">
  <div class="container-fluid container-flex">
    <div class="center-block table-responsive">
      <table class="table-striped table-bordered table-condensed table-curved sortable" id="sortablegrid19519">
        <thead>
        <tr>
          <input type="hidden" name="ROWCOUNTCB19519" id="ROWCOUNTCB19519" value="1">
          ...
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 18);return false;">Debit Reconciled To Statement<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 19);return false;">Credit Reconciled To Statement<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 20);return false;">Sold By<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 21);return false;">Payment Processor<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 22);return false;">Fiscal Year<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 23);return false;">In Person Deposit<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
          <th><a href="#" class="sortheader" onclick="ts_resortTable(this, 24);return false;">Booth Payment Type<span class="sortarrow"><img border="0" src="1.gif" alt="↓"></span></a></th>
        </tr>
        </thead>
        <tbody>
        <tr>
          <td class="text-center " id="TD19519ROW0DATA54457">
            I
          </td>
          <td class="text-center " id="TD19519ROW0DATA54458">
            1/13/2026 9:30:04 PM
          </td>
          <td class="text-center " id="TD19519ROW0DATA54459">
            Russ Chidester
          </td>
          <td class="text-center " id="TD19519ROW0DATA54460">
            Deposit To Member Account
          </td>
          <td class="text-center " id="TD19519ROW0DATA54461">
            01/13/2026
          </td>
          <td class="text-center " id="TD19519ROW0DATA54462">
            01/13/2026
          </td>
          <td class="text-center " id="TD19519ROW0DATA54463">
            Chk#1967 for Winter Overnight
          </td>
          <td class="text-center " id="TD19519ROW0DATA54464">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54465">
            70.00
          </td>
          <td class="text-center " id="TD19519ROW0DATA54466">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54467">
            Frost Bank Checking Account
          </td>
          <td class="text-center " id="TD19519ROW0DATA54468">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54469">
            Workman, Logan
          </td>
          <td class="text-center " id="TD19519ROW0DATA54470">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54471">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54472">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54473">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54474">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54475">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54476">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54477">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54478">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54479">
            &nbsp;
          </td>
          <td class="text-center " id="TD19519ROW0DATA54480">
            No
          </td>
          <td class="text-center " id="TD19519ROW0DATA54481">
            &nbsp;
          </td>
        </tr>
        </tbody>
        ...
        <tr>
          <td colspan="25" class="text-center">
            <input type="button" value="Print (Export to PDF)" onclick="window.open('FormReport.aspx?Menu_Item_ID=357&amp;Form_ID=319&amp;ID=2570&amp;Stack=3&amp;SectionID=19519&amp;ReportFormat=PDF','_blank');"> &nbsp; &nbsp; <input type="button" value="Open in Excel" onclick="window.open('FormReport.aspx?Menu_Item_ID=357&amp;Form_ID=319&amp;ID=2570&amp;Stack=3&amp;SectionID=19519&amp;ReportFormat=XLS','_blank');">
          </td>
        </tr>
        </tfoot>
      </table>
